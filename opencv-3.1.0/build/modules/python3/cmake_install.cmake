# Install script for directory: /home/gloria/Downloads/opencv-3.1.0/modules/python/python3
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "python")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python3.4/dist-packages/cv2.cpython-34m.so" AND
    ...
    FILE(RPATH_CHECK
         ...
         RPATH "/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python3.4/dist-packages" TYPE MODULE OPTIONAL FILES "/home/gloria/Downloads/opencv-3.1.0/build/lib/python3/cv2.cpython-34m.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python3.4/dist-packages/cv2.cpython-34m.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python3.4/dist-packages/cv2.cpython-34m.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python3.4/dist-packages/cv2.cpython-34m.so"
