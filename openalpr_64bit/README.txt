...
In order to run OpenALPR, you must first install the Windows Visual C++ runtime libraries.  The installer (vc_redist.x64.exe or vc_redist.x86.exe) is included 
in the package.

Test the program by running the command line application.  For example, open a command prompt and type:
